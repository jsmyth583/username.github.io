...
function jayResponse(message) {
    ...
    if (state === 'initial' || message.toLowerCase().includes("hi") || message.toLowerCase().includes("hello")) {
    ...
    } else if (state === 'waitingForScreenshotConfirmation' && message === "no_uploaded") {
        response = "Please upload a screenshot of your review and let me know once it's uploaded.";
        addMessage("Jay: " + response);
        ...
        response = "Thank you! We will validate your review and send your voucher to " + message + ". Don't forget to check your spam folder. We hope to serve you soon! Regards, Jay.";
        addMessage("Jay: " + response);
        state = 'end';
    } else {
