...
function askWhereToReview() {
    askQuestion("Jay: Where would you like to leave your review?", [
        { text: "Google", value: "google" },
        { text: "Facebook", value: "facebook" },
        { text: "Post on Social Media (Facebook/Instagram)", value: "social" }
    ], handleReviewPlatform);
}
...
function askSocialMediaPost() {
    addMessage("Jay: 📲 To qualify for a reward, please follow these steps:", "bot");

    addMessage("✅ Like our pages on Facebook & Instagram:\n" +
    ...
    addMessage("📸 **Post this image** on your story or feed and tag us:\n" +
               "[Click here for the image](https://scontent-man2-1.xx.fbcdn.net/v/t39.30808-6/481024849_1437852797540419_1520032287454362269_n.jpg)", "bot");

    askQuestion("Jay: Have you posted and tagged us?", [
        { text: "Yes, I have!", value: "yes" },
        { text: "No, I'll do it now", value: "no" }
    ], confirmSocialPost);
}

function confirmSocialPost(response) {
    if (response === "yes") {
        askForScreenshot();
    } else {
        addMessage("Jay: No problem! Let me know once you've posted it.", "bot");
    }
}
